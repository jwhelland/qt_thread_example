...
class getPostsThread(QThread):
    ...
    def _get_top_post(self, subreddit):
        ...
        headers = {'User-Agent': 'tutorial code'}
    ...
    def run(self):
        ...
        for subreddit in self.subreddits:
            ...
            self.signal.emit(top_post)
            self.sleep(2)

class ThreadingTutorial(QtWidgets.QMainWindow, design_qt5.Ui_MainWindow):
    """
    ...
    def start_getting_top_posts(self):
        ...
        self.get_thread.signal.connect(self.add_post)
